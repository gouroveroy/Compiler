...
STRUCT   : 'struct'   { writeIntoLexLogFile("Line# " + to_string(getLine()) + ": Token <STRUCT> Lexeme " + getText()); }
         ;

FORIN    : 'forin'  { writeIntoLexLogFile("Line# " + to_string(getLine()) + ": Token <FORIN> Lexeme " + getText()); }
         ;

FOREACH  : 'foreach'  { writeIntoLexLogFile("Line# " + to_string(getLine()) + ": Token <FOREACH> Lexeme " + getText()); }
         ;

IN       : 'in'       { writeIntoLexLogFile("Line# " + to_string(getLine()) + ": Token <IN> Lexeme " + getText()); }
         ;

TO      : 'to'       { writeIntoLexLogFile("Line# " + to_string(getLine()) + ": Token <TO> Lexeme " + getText()); }
         ;
...
COLON     : ':'
          { writeIntoLexLogFile("Line# " + to_string(getLine()) + ": Token <COLON> Lexeme " + getText()); }
          ;

TERNARY   : '?'
          { writeIntoLexLogFile("Line# " + to_string(getLine()) + ": Token <TERNARY_OP> Lexeme " + getText()); }
          ;
